...
describe('Deleting pets', () => {
  ...
  it('should return 404 when a non-existing ID is provided', async () => {
    const nonExistingPetId = 999999; // Assuming this ID does not exist
...
describe('Updating pets', () => {
  ...
  // Test when a valid ID and data are provided
  it('should return 405 when a valid ID and data are provided', async () => {
    const petId = 1; // Assuming this ID exists
  ...
  // Test when a non-existing ID is provided
